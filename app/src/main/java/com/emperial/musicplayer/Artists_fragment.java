...
public class Artists_fragment extends Fragment {
     ...
     * @return A new instance of fragment Artists_fragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       gridview=layout.findViewById(R.id.artistgrid);

        ArrayList<Artist_model> artistlist=((MainActivity)getActivity()).artist_adapter_data;
artist_adapter artist_adapter =new artist_adapter(getActivity(),artistlist);
